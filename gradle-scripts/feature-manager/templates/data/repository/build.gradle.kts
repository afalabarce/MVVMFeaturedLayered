...
android {
    namespace = "${BuildVersion.environment.applicationId}<FEATURE_PACKAGE>.data.data"
...
dependencies {
    ...
    implementation(project(mapOf("path" to ":<FEATURE>:domain:repository")))
    implementation(project(mapOf("path" to ":<FEATURE>:data:gateway")))
    implementation(project(mapOf("path" to ":<FEATURE>:data:models")))
